---
title: "Automated MAIT cell annotation in Lett dataset (blood) using SingleR"
subtitle: "scRNA-seq workflow series part5" 
...
```{r, warning= FALSE, message= FALSE, echo= TRUE}
lett.sce <- readRDS("./../input/Lett.sce.blood.gene.symbol_analyzed.rds")
lett.sce
...
### Conclusion: 4.3 % MAIT cells out of all T cells in blood

# Analysis with SingleR and Garner et al. reference

Let's load the new reference data (blood subset) which we saved from previous Seurat analysis

```{r}
ref2 = readRDS("./../output/Garner.seurat.2exp.blood.mait_analyzed.rds")
```
